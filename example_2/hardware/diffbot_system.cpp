  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  hw_interfaces_["left"] = Joint("left_wheel_joint");

  hw_interfaces_["right"] = Joint("right_wheel_joint");
...
std::vector<hardware_interface::CommandInterface> DiffBotSystemHardware::export_command_interfaces()
{
  ...
  command_interfaces.emplace_back(hardware_interface::CommandInterface("right_wheel_joint", hardware_interface::HW_IF_VELOCITY, &right_wheel_speed_));
  command_interfaces.emplace_back(hardware_interface::CommandInterface("left_wheel_joint", hardware_interface::HW_IF_VELOCITY, &left_wheel_speed_));
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  // auto node = rclcpp::Node::make_shared("carlikebot_system_hardware");
  // timer_ = node->create_wall_timer(
  //   500ms, std::bind(&CarlikeBotSystemHardware::update_commands, this));
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  std::string command = std::to_string(left_wheel_speed_) + " " + std::to_string(right_wheel_speed_) + "\n";
